...
I know in this case, the differences in OOB error are honestly not that much different, but my recent project, they differed by 20%, where I had a 45% using classification, and 25% using probability.
