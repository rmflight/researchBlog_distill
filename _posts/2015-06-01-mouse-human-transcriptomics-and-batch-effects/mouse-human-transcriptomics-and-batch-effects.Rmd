...
```{r fig2, echo = FALSE, preview = TRUE}
knitr::include_graphics("41586_2014_Article_BFnature13992_Fig2.webp")
```
...
On April 28, Y. Gilad sent out [this tweet](https://twitter.com/Y_Gilad/status/593088451462963202):

> We reanalyzed the data from <a href="http://t.co/Fv7z9WwLJ4">http://t.co/Fv7z9WwLJ4</a> and found the following: <a href="http://t.co/37eVs8Kln9">pic.twitter.com/37eVs8Kln9</a>
...
```{r yoav_fig1, echo = FALSE}
knitr::include_graphics("9f5f4330-d81d-46b8-9a3f-d8cb7aaf577e_figure1.gif")
```
...
```{r table1, echo = FALSE}
knitr::include_graphics("slin_table1part2.jpg")
```

```{r newpca, echo = FALSE}
knitr::include_graphics("slin_fig1part2.jpg")
```
